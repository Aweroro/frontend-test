    ...
    <div className="bg-black shadow-lg rounded-lg p-4 flex flex-col space-y-2">
      <button
        className={`p-2 rounded ${
          selectedTool === "highlight" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-700"
        }`}
      ...
      <button
        className={`p-2 rounded ${
          selectedTool === "underline" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-700"
        }`}
      ...
      <button
        className={`p-2 rounded ${
          selectedTool === "comment" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-700"
        }`}
      ...
      <button
        className={`p-2 rounded ${
          selectedTool === "signature" ? "bg-blue-500 text-white" : "bg-gray-100 "
        }`}
